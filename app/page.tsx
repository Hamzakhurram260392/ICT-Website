...
//           <a className="py-3 px-12 border-[#3D4098] border-3 text-[#3D4098] font-bold text-xl rounded-lg" href="https://docs.google.com/forms/d/e/1FAIpQLSe0xltybDdhgmuadGDd6MJ8YU_wQejb9qRXZ5wYEIJgTIeQag/viewform">Explore</a>
//           </div>
//           </div> 
    ...
    <div className="">
      ...
      <div className="flex justify-start px-28 py-10 gap-10">
        ...
        <div>
          ...
          <div className="mt-12 gap-4 flex">
            <a className="bg-[#3D4098] py-4 px-10 text-white font-bold text-xl rounded-lg" href="">Enroll Now</a>
          <a className="py-3 px-12 border-[#3D4098] border-3 text-[#3D4098] font-bold text-xl rounded-lg" href="/membership">Membership</a>
          </div>
          </div> 
        <div className="flex justify-center ml-40"><img className="h-[500px] w-[300px] " src="h1.png" alt="" />
        <img className="h-[200px] w-[200px] " src="t1.png" alt="" />
...
//     const scale = 1 - 0.5 * Math.abs(angle) / Math.PI;
...
//           {/* Center Circle */}
//           <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center shadow-2xl">
...
//           <div
//             key={item.id}
//             className="absolute top-1/2 left-1/2 w-32 h-32 -ml-16 -mt-16 transition-all duration-1000 ease-out"
...
// export default MinimalCircularSlider;