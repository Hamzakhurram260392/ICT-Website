...
// ---------------- COURSE DATA ----------------
const courseData = [
  { title: "Basics of InternationalTrade", desc: "Learn global trade operations, key market dynamics, essential terminology, and common risks in international trading." },
  { title: "Legal & Regulatory Requirements", desc: "Learn trade laws, customs procedures, licensing, and compliance steps for smooth international transactions and choosing the right business setup." },
  { title: "Import & Export Documentation", desc: "Learn to prepare and verify essential customs, shipping, and payment documents to avoid delays and legal issues." },
  { title: "Logistics, Shipping & Incoterms", desc: "Understand freight forwarding, customs, and Incoterms to manage global shipments efficiently." },
  { title: "Payment Methods & Business Incentives", desc:"Learn secure export payment methods, import handling, bank instruments, and government schemes for exporters." },
  { title: "Trade Portals & Online Application Procedures", desc:"Learn to use online portals for import/export registration, duties, and licenses, and manage digital trade applications confidently." },
  { title: "Trade Portals & Online Application Procedures", desc: "Learn to use online portals for import/export registration, duties, and licenses, and manage digital trade applications confidently." },
  { title: "Market Research & Business Growth", desc: "Learn to use online tools to find international buyers, analyze demand, and select high-potential products for export." },
];
      ...
      <section className="w-full bg-linear-to-r from-[#f7f7f7] via-[#eef6fb] to-[#dfe7f3] py-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
           ...
           Master Import & Export <br />
              <span className="text-[#18a957]">Operations</span>
            </h1>
            <p className="mt-6 text-lg text-gray-700 max-w-xl">
              Learn import and export processes, documentation, and compliance for efficient international trade.
            </p>
          ...
          <div className="grid grid-cols-2 gap-6 relative">
            <div className="w-full aspect-square  overflow-hidden">
              <Image src="/i1.png" alt="UK Taxes" width={400} height={400} className="w-full h-full object-cover" />
            </div>

            <div className=" overflow-hidden">
              <Image src="/i3.png" alt="Income Tax" width={400} height={400} className="w-full h-full object-cover" />
            </div>

            <div className=" overflow-hidden">
              <Image src="/i2.png" alt="Tax Relief" width={400} height={400} className="w-full h-full object-cover" />
            </div>

            <div className=" overflow-hidden ">
              <Image src="/i4.png" alt="Tax Growth" width={400} height={400} className="w-full h-full object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative flex gap-2">
            <div className="w-[48%] rounded-4xl overflow-hidden shadow-lg">
              <Image src="/i10.png" alt="Tax on Mobile" width={500} height={700} className="w-full h-full object-cover" />
            </div>
            <div className="w-[52%]  overflow-hidden shadow-xl mt-16">
              <Image src="/i5.png" alt="Tax Dashboard" width={500} height={700} className="w-full h-full object-cover" />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-lg text-gray-800 mb-10">
              ICT’s Import & Export Course offers hands-on training for aspiring traders and business professionals. Learn global trade procedures, including documentation, INCOTERMS, customs, shipping, payments, HS codes, and regulatory compliance. Gain practical skills to start your own venture or work in logistics and trading firms confidently.
            </p>
...
<section className="w-full bg-white py-20">
  <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
    ...
    <div>
      ...
      Benefits of the Import and Export Course
      </h2>
      ...
      <div className="grid md:grid-cols-2 gap-x-12 gap-y-10">
        ...
        <div>
          ...
          <h4 className="text-lg font-semibold text-black mt-2">
           Practical Knowledge of Global Trade
          </h4>
        ...
        <div>
          ...
          <h4 className="text-lg font-semibold text-black mt-2">
       Start or Grow Your Import/Export Business
          </h4>
          <p className="text-gray-600 mt-2 text-sm">
           This course equips you to handle trade regulations, supplier management, and international logistics for new or expanding ventures.
          </p>
        </div>
        ...
        <div>
          ...
          <h4 className="text-lg font-semibold text-black mt-2">
           High-Demand Skills for Jobs & Freelance Work
          </h4>
          <p className="text-gray-600 mt-2 text-sm">
           Trained professionals are sought by trading companies, logistics firms, and customs agencies, with opportunities to offer freelance import/export consultancy.
          </p>
        </div>
        ...
        <div>
          ...
          <h4 className="text-lg font-semibold text-black mt-2">
           Opportunity to Work with Global Markets
          </h4>
          <p className="text-gray-600 mt-2 text-sm">
          Learn to manage suppliers, buyers, and regulators worldwide, expanding markets and strengthening international business relationships.
          </p>
        </div>
      </div>
    </div>
